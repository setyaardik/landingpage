  ...
  >
    ...
    <div className="mx-auto max-w-3xl px-6">
      ...
      <p className="text-lg leading-relaxed bg-white bg-opacity-80 text-gray-800 rounded-lg p-4">
        Nama Kendal sudah ada sejak Kerajaan Demak dengan sebutan seperti
        Kendalpura, Kontali, atau Kentali. Dalam Babad Tanah Jawi, nama Kendal
        berasal dari Pohon Kendal. Kisahnya berkaitan dengan Sunan Katong dan
        Empu Pakuwojo, seorang sakti yang pernah menjadi pejabat bawahan
        Majapahit. Sunan Katong datang ke Kendal untuk menyebarkan Islam dan
        menantang Pakuwojo beradu kesaktian, dengan syarat jika kalah, Pakuwojo
        harus masuk Islam. Setelah pertarungan panjang, Pakuwojo terdesak dan
        bersembunyi di dalam lubang pohon besar bernama Kendal, yang berarti
        penerang.
      </p>
    </div>
  </div>
