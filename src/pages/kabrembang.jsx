...
import Anjungan from "../images/kabrembang/anjungan.png";
import Tradisi from "../images/kabrembang/tradisi.png";
import Makanan from "../images/kabrembang/makanan.png";
import WisataSejarah from "../images/kabrembang/wisatasejarah.png";
  ...
  >
    ...
    <div className="mx-auto max-w-3xl px-6">
      <div className="relative group">
        <img
          src={Anjungan}
          alt="Anjungan Kabupaten Rembang"
      ...
      Rembang disebut dalam Kitab Negara Kertagama dan catatan Tome Pires sebagai kota penting di pantai utara Jawa. Nama Rembang diduga berasal dari tradisi "ngRembang sakawit," upacara pemangkasan tebu oleh pendatang Campa pada tahun Saka 1337.</p>
    </div>
  </div>
);
...
const Home = () => (
  <div className="bg-gradient-to-b from-yellow-50 via-red-50 to-yellow-100 min-h-screen flex flex-col">
    ...
    <Section
      title="Tradisi"
      description="Salah satu tradisi yang ada di kabupaten rembang adalah Pathol Sarang. Pathol Sarang adalah seni gulat tradisional dari Kabupaten Rembang, Jawa Tengah. Permainan ini mirip dengan gulat dan sumo, dan biasanya diikuti oleh nelayan setempat. "
      image={Tradisi}
    />
    <Section
      title="Makanan Khas"
      description="Salah satu makanan khas Kabupaten Rembang adalah Sayur Merica. Sayur merica merupakan masakan khas Rembang yang bumbunya didominasi oleh merica. Merica sendiri merupakan rempah-rempah yang berasal dari buah tanaman Piper nigrum. "
      image={Makanan}
    />
    <Section
      title="Wisata"
      description="Makam R.A. Kartini. Raden Ajeng atau RA Kartini atau lebih dikenal dengan Ibu Kartini berasal dari Jepara, tapi beliau dimakamkan di Rembang. Kartini meninggal dunia di usia 25 tahun tepatnya pada tanggal 17 September 1904."
      image={WisataSejarah}
    />
    <Footer />
  </div>
