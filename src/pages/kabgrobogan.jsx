...
import AnjunganImage from "../images/kabgrobogan/anjungan.png";
import Batik from "../images/kabgrobogan/batik.png";
import Tradisi from "../images/kabgrobogan/tradisi.png";
import Wisata from "../images/kabgrobogan/wisata.png";
  ...
  >
    ...
    <div className="mx-auto max-w-3xl px-6">
      ...
      <p className="text-lg leading-relaxed bg-white bg-opacity-80 text-gray-800 rounded-lg p-4">
        Kabupaten Grobogan, berdiri resmi pada 4 Maret 1726 saat Susuhunan
        Amangkurat IV mengangkat bupati pertama, Ngabehi Wongsodipo. Nama
        "Grobogan" berasal dari legenda bunyi jatuhnya pusaka Sunan Ngundung,
...
const Home = () => (
  <div className="bg-gradient-to-b from-yellow-50 via-red-50 to-yellow-100 min-h-screen flex flex-col">
    ...
    <Section
      title="Kebudayaan"
      description='Batik Grobogan adalah kerajinan khas dengan motif unik seperti "Pring Sedapur," padi, jagung, dan kedelai, yang mencerminkan kekayaan lokal'
      image={Batik}
    />
    <Section
      title="Tradisi"
      description='Boyong Grobog adalah kirab budaya untuk memperingati perpindahan pusat pemerintahan Grobogan ke Purwodadi pada 1864. Tradisi ini ditandai dengan arak-arakan pusaka dalam "grobog" sebagai simbol sejarah.'
      image={Tradisi}
    />
    <Section
      title="Wisata"
      description="Air Terjun Widuri di Grobogan memiliki ketinggian 40 meter, dikelilingi oleh alam hijau yang asri dan sejuk. Legenda setempat menyebut air terjun ini sebagai tempat mandi para bidadari.
Lokasi di  Desa Kemadohbatur, Kecamatan Tawangharjo, Kabupaten Grobogan"
      image={Wisata}
    />
    <Footer />
    <BackButton />
