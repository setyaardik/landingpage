  ...
  >
    ...
    <div className="mx-auto max-w-3xl px-6">
      ...
      <p className="text-lg leading-relaxed bg-white bg-opacity-80 text-gray-800 rounded-lg p-4">
        Kebumen, dahulu disebut Panjer, memiliki sejarah erat dengan Kesultanan
        Mataram Islam. Nama ini berasal dari "Kabumian," tempat tinggal Pangeran
        Mangkubumi yang melarikan diri pada 1677. Wilayah ini berkontribusi
        dalam penyerbuan Sultan Agung ke Batavia dan kaya akan warisan budaya
        dari berbagai era.
      </p>
    </div>
  </div>
